...
var URLFILE = "tmp.html";
 ...
 var assertURLFileExists = function(inurl) {
   var instr = inurl.toString();
   var response2file = buildfn(URLFILE);
...
if(require.main == module) {
    program
        ...
        .option('-u, --url <url_to_file>', 'URL to index.html', clone(assertURLFileExists), URLFILE_DEFAULT)
        .parse(process.argv);
    if(program.url == '') {
